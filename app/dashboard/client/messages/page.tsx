...
import { MessageSquare, Reply, Plus, Trash2, Check, Filter, X } from "lucide-react"
...
function ClientMessagesContent() {
  ...
  useEffect(() => {
    if (projectFilter) {
      setFilteredMessages(messages.filter(msg => msg.projectId === projectFilter))
    } else {
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          <p className="text-muted-foreground">
            {projectFilter ? "Project-specific messages" : "Communication with your project team"}
          </p>
          {projectFilter && (
      ...
      <MessageForm 
        ...
        initialProject={replyTo?.projectId || projectFilter || undefined}
      />
      ...
      <div className="grid gap-4">
        {loading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground">
              {projectFilter ? "No messages found for this project" : "No messages found"}
            </p>
            <p className="text-sm text-muted-foreground mt-1">
              {projectFilter ? "Start a conversation about this project" : "Start a conversation by sending a message"}
            </p>
          </div>
        ) : (
